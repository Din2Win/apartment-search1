        ...
        <form method="get" action="searchAptsProc.php" onsubmit="return validateMinMaxRent()">
            ...
            <p>Sort by:
              ...
              Results Per Page:
                ...
                <br/>
                <input type="radio" name="ascDesc" value="asc" class="cbW" id="asc"> 
                <label for="asc">Ascending</label>
                <input type="radio" name="ascDesc" value="desc" class="cbW" id="desc">
            ...
            <p><button style="width:100%; padding:5px; fontsize:1rem; font-weight:600; color:#363; background-color:#8C8; letter-spacing:10px; text-transform:uppercase;">Submit</button></p>
